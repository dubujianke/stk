...
public class TableConst {
    ...
    public static Row getHeader() {
        ...
        try {
            ...
            row.add(new Col("prev_(3)"));
            row.add(new Col("prev_(2)"));
            row.add(new Col("prev_(1)"));
            row.add(new Col("cur_"));
            row.add(new Col("min_entity"));
...
//            row.add(new Col("日MINMA压力"));
            ...
            row.add(new Col("70%cmf"));
            row.add(new Col("90%cmf"));
            row.add(new Col("fracTrap"));
            row.add(new Col("fracZt"));
            row.add(new Col("fracZt2"));
            row.add(new Col("fracProfit"));
            row.add(new Col("fracTrapInProfit"));
            row.add(new Col("fracTrapInZtUp"));
            row.add(new Col("minLine"));
            row.add(new Col("priceZf"));
