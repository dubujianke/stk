...
import com.alading.trace.TimeTJ;
...
import static com.alading.tool.stock.StragetyZTBottom.MONITOR_DATE;
...
public class AbsStragety {
    ...
    public static boolean usecmf = true;
    public static boolean useSingleCode = true;
    ...
    static {
        ...
        MAP.put("IsBottomGetNextZTAndFensh", new IsBottomGetNextZTAndFensh());
        MAP.put("IsBottomHorXRZL", new IsBottomHorXRZL());
        MAP.put("IsZhangting", new IsZhangting());
        MAP.put("IsZhangtingHorUp", new IsZhangtingHorUp());
...
//        }
    ...
    public static void prsIsN(String file, List<Kline> days, String date, String stragetyName, int usemonth, int useweek, LineContext context) {
        ...
        SingleContext singleContext = AbsStragety.getContext(getCode(file), date);
