...
/////////////////////////////////////////////////////////////////////////////
        ...
        try {
            com.alading.tool.stock.Kline.LocalBottom localBottom = kline0.getLocalBottom();
            if (localBottom.flag) {
...
//        }
        ...
        {
            boolean fflag63 = kline0.monthKline.allIsLessAbsThanExceptNoSelf(3, 2, 2.0f, 0, 0.0, 0, 0.0, 3.0f);
            if (fflag63) {
        ...
        {
            //603389
            boolean fflag63 = kline0.allIsLessAbsThanExcept(4, 0, 2.0f, 0, 0.0, 0, 0.0, 1.5f);
            if (fflag63) {
