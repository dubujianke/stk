...
public class TreeGraph {
    public static TreeGraph instance = new TreeGraph();
    static {
        //tree00
//        instance.read("D:\\py\\pythonProject\\tree3.dot");
        instance.read("D:\\py\\pythonProject\\zt_1210.dot");
    }
    ...
    public Boolean[] process(Table row, int rowIdx) {
        ...
        flag[0] = root.getLeft().process(row, rowIdx);
        flag[1] = root.getRight().process(row, rowIdx);
        return flag;
    }
...
//                    Log.log(first+" ----> "+last);
    ...
    public static void main(String[] args) {
        TreeGraph aTreeGraph = new TreeGraph();
        aTreeGraph.read("D:\\py\\pythonProject\\tree.dot");
