...
public class KLineUtil {
    ...
    public static double compareMax(double v1, double v2) {
        ...
        return Math.abs(100.0 * (v1 - v2) / v2);
    }
    ...
    public static double getMinAbs(double v1, double v2, double v3, double v4) {
        double min = 999;
        v1 = Math.abs(v1);
        v2 = Math.abs(v2);
        v3 = Math.abs(v3);
    ...
    public static boolean abousNearest(double v1, double v2, double vv) {
        double f = Math.abs(100.0 * (v1 - v2) / v2);
        if (f <= vv) {
            return true;
        }
        return false;
