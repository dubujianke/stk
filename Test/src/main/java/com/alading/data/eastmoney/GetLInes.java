...
import static com.alading.tool.stock.AbsStragety.FILE;
...
public class GetLInes {
    ...
    public static List<Kline> getFromNet(String code) throws IOException {
        try {
