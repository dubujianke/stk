...
public class TreeGraphBottomAfter {
    public static TreeGraphBottomAfter instance = new TreeGraphBottomAfter();
    static {
        instance.read("D:\\py\\pythonProject\\zt_bottom_after.dot");
    }
    ...
    public static void main(String[] args) {
        TreeGraphBottomAfter aTreeGraph = new TreeGraphBottomAfter();
