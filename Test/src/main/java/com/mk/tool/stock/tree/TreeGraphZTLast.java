...
public class TreeGraphZTLast {
    public static TreeGraphZTLast instance = new TreeGraphZTLast();
    static {
        instance.read("D:\\py\\pythonProject\\zt_bottom_1.dot");
    }
    ...
    public static void main(String[] args) {
        TreeGraphZTLast aTreeGraph = new TreeGraphZTLast();
