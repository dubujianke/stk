...
public class TreeGraph2 {
    public static TreeGraph2 instance = new TreeGraph2();
    static {
        instance.read("D:\\py\\pythonProject\\tree9.dot");
    }
    ...
    public static void main(String[] args) {
        TreeGraph2 aTreeGraph = new TreeGraph2();
