 ...
 * 大底
 */
public class IsBottom_ extends Stragety {
    ...
    static ReConstructTreeGraph aFilterTreeGraph = ReConstructTreeGraph.instance("D:\\py\\pythonProject\\all_nominute3.dot");
...
//                            + "	guben:" + StringUtil.spaceString(StringUtil.format3(guben, 0), 3)
//                            + "	type:" + 1
//                            + "	LFT:" + 0
//                            + "	RGT:" + 0
//            );
...
//        String itemName = lineReport.getSerieName(0);
//        List<Integer> vlist = lineReport.getSeries(0);
//        for(int i=0; i<5; i++) {
//        }
//        lineReport.isFirstSpeedDownWithVOLInDays(context);
    }
...
//        }
    ...
    private boolean addOK(String file, List<Kline> days, String date, List<Weekline> weeks, List<MonthKline> moths, int usemonth, int useweek, LineContext context, Kline kline0) {
        if (!Stragety.isResult) {
            ...
            result.stragety = IsBottom_.class.getSimpleName();
