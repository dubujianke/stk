...
import static com.mk.tool.stock.AbsStragety.FILE_MINUTE;
import static com.mk.tool.stock.AbsStragety.FILE_MINUTE_DATE;
...
//            e.printStackTrace();
    ...
    public static MinuteLine getFirstSpeedUp(Kline kline, StockAllMinuteLine stockAllMinuteLine, String code, String date, LineContext context) {
        ...
        MinuteLine minuteLine = stockDayMinuteLine.getFirstSpeedUp(kline, context);
        return minuteLine;
    }
